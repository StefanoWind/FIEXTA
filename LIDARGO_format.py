...
class LIDARGO():
    ...
    def process_scan(self, source, model, site,z_id, data_level_out, save_file=True, save_path=None, replace=True):
        ...
        '''
        if model=='Halo XR':
            source00=self.rename_halo_xr(source,site,z_id,save_path,replace)
        elif model=='WindCube 200S':
            source00=self.rename_windcube_200s(source,site,z_id,save_path,replace)
        else:
...
if __name__ == '__main__':
    ...
    Test block
    '''
    source='C:/Users/SLETIZIA/OneDrive - NREL/Desktop/PostDoc/Technical/LiDAR/LIDARGO/data/Example5/sc1.lidar.z02.00.20230822.071301.ppi.50.nc'
    site='sc1'
    model='WindCube 200S'
    z_id='02' 
    data_level_out='a0'
    save_path='C:/Users/SLETIZIA/OneDrive - NREL/Desktop/PostDoc/Technical/LiDAR/LIDARGO/data/Example5/'
