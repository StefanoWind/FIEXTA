...
source_config_stand = "../20241031.RAAW.config_raaw_b1.xlsx"
...
exampleFilePath = "/scratch/nhamilto/raaw/nrel.lidar.z02.b0/nrel.lidar.z02.b0.20230407.073004.user5.nc"
...
b0.process_scan(replace=True, save_file=True, make_figures=False, save_path=".")
